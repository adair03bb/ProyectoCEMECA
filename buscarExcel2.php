...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td>' . $row['juez_control'] . '</td>';
        ...
        $output['data'] .= '<td>' . $row['delito1'] . '</td>';
        $output['data'] .= '<td>' . $row['delito2'] . '</td>';
        $output['data'] .= '<td>' . $row['delito3'] . '</td>';
        $output['data'] .= '<td>' . $row['delito4'] . '</td>';
        ...
        $output['data'] .= '<td>' . $row['nuevo_tipo_riesgo'] . '</td>';
        $output['data'] .= '<td>' . $row['riesgo168'] . '</td>';
        $output['data'] .= '<td>' . $row['riesgo169'] . '</td>';
        $output['data'] .= '<td>' . $row['riesgo170'] . '</td>';
        $output['data'] .= '<td>' . $row['fecha_envio'] . '</td>';
        $output['data'] .= '<td>' . $row['hora_envio'] . '</td>';
        $output['data'] .= '<td>' . $row['estado'] . '</td>';
        $output['data'] .= '<td>' . $row['verificada'] . '</td>';
